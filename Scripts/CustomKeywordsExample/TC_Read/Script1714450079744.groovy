...
if ((connection != null) && !(connection.isClosed())) {
    ...
    ResultSet resultSet = CustomKeywords.'sql_serverConnection.ExcecutingFirstQuerySQLServer.getAdmiByIdAdmin'(5)

    if (resultSet.next()) {
        System.out.println((('USERNAME : ' + resultSet.getString('username')) + ' & PASSWORD : ') + resultSet.getString(
                'password'))
    }
